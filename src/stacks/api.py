...
class ApiConstruct(Construct):
    ...
    def _setup_agent_endpoint(self, get_lambda: lambda_.Function, delete_lambda: lambda_.Function) -> None:
        ...
        resource.add_method("GET", apigateway.LambdaIntegration(get_lambda, proxy=True), api_key_required=False)
        resource.add_method("DELETE", apigateway.LambdaIntegration(delete_lambda, proxy=True), api_key_required=False)
