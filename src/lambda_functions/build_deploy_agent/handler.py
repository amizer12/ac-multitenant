...
subprocess.check_call([sys.executable, "-m", "pip", "install", "--upgrade", "boto3", "uv", "requests", "-t", "/tmp/packages"])
...
def build_agent_project(tenant_id='default', config=None, agent_runtime_id='pending', template_config=None, tools_config=None):
    ...
    subprocess.run(['uv', 'init', project_dir, '--python', '3.13'], check=True, cwd='/tmp')
